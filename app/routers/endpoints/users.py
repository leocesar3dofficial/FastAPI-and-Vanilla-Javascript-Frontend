...
from support.email import send_new_account_email
...
def update_user_me(
    *,
    ...
    Update own user.
    """
    user_exist = crud.user.get_by_email(db, email=email)
...
def update_user(
    *,
    ...
    Update a user.
    """
    user_exist = crud.user.get(db, id=user_id)
    ...
    user_exist = crud.user.update(db, db_obj=user_exist, obj_in=user_in)
    return user_exist
